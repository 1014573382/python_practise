...
class TestCaseLogin(HttpRunner):
    ...
    teststeps = [
        Step(
            RunRequest("/v3/api/desktop_client/latest_version")
            .post("https://api2.mubu.com/v3/api/desktop_client/latest_version")
            .with_headers(
                **{
                    "content-length": "17",
        ...
        Step(
            ...
            .with_json(
                {"phone": "15222186256", "password": "gxl10230701", "callbackType": 0}
            )
            .validate()
            .assert_equal("status_code", 200)
            .assert_equal("body.code", 0)
